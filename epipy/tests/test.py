...
def base_model_test(class_instance, **param):
	I0=0.3; time = np.arange(1, 120+1, 1); N = 5
...
# fit_test(siswbad, beta=0.20559639, gamma=0.11329984, mu=0) # looks weird
